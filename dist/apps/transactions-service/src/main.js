...
async function bootstrap() {
    ...
    const logger = new common_1.Logger('TransactionsBootstrap');
    ...
    app.connectMicroservice((0, shared_1.buildKafkaOptions)(configService, 'transactions-service', 'transactions-service-group'));
    await app.startAllMicroservices();
    await app.listen(port);
    logger.log(`transactions-service listening on port ${port}`);
